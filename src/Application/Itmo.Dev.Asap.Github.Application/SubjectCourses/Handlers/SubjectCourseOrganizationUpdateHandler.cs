    ...
    IRequestHandler<UpdateSubjectCourseOrganization.Command>
{
    ...
    private readonly SubjectCourseOrganizationUpdateOptions _options;
    ...
    public SubjectCourseOrganizationUpdateHandler(
        ...
        IOptions<SubjectCourseOrganizationUpdateOptions> configuration)
    {
        _logger = logger;
    ...
    {
        var request = new GetSubjectCourseStudentsRequest(subjectCourse.Id, null, _options.StudentPageSize);
